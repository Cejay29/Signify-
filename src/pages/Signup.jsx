...
export default function Signup() {
  ...
  return (
    <div className="bg-[#0c0731] min-h-screen flex items-center justify-center relative font-[Inter] overflow-hidden">
      ...
      <button
        onClick={() => navigate("/")}
        className="fixed top-4 left-4 text-white text-3xl z-50"
      >
        ✕
      </button>

      {/* ✅ Signup Card */}
      <div className="z-10 w-full max-w-xl sm:max-w-2xl md:max-w-3xl px-4">
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <input
                  ...
                  required
                  onChange={update}
                  className="p-3 border rounded-xl w-1/2"
                />
                <input
                  name="lastName"
            ...
            <div>
              ...
              <select
                ...
                required
                onChange={update}
                className="p-3 border rounded-xl w-full mt-1 bg-white"
              >
            ...
            <Link
              to="/login"
              className="text-center text-blue-500 text-sm hover:underline mt-1"
            >
